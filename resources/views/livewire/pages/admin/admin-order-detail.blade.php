    ...
    <div class="container mx-auto mt-10">
        <div class="flex shadow-md my-10">
            <div class="w-full bg-white px-10 py-10">
                <h1 class="font-semibold text-3xl pb-5 mb-3">Order Details</h1>
                                    ...
                                    @forelse ($orders as $order )
                                        @foreach ($order->orderDetails as $index => $orderDetail)
                                            <tr class="bg-white border-b hover:bg-gray-100 text-center text-[#1A120B]">
                                                ...
                                                <td class="py-4 px-6"><img
                                                        src="{{ asset('storage/' . $orderDetail->products->product_image) }}"
                                                        alt="{{ $orderDetail->products->product_name }}" width="100px">
                                                </td>
                                                <td>{{ $orderDetail->products->product_name }}</td>
                                                <td>{{ $orderDetail->products->product_category }}</td>
                        ...
                        <div class="button-section">
                            <div class="mb-3">
                                <button type="button" wire:click='updateOrder'
                                    ...
                                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700  focus:outline-none dark:focus:ring-blue-800 disabled:bg-gray-500 disabled:hover:bg-gray-500">
                                    {{ $order->order_status == 'Wait Confirmation' ? 'Accept Order' : ($order->order_status == 'Wait Courier' ? 'Send Now' : 'Delivering...') }}
                                </button>
                                <button type="button"
