<div>
        ...
        <div class="container mx-auto flex justify-center">
            <h1 class="text-6xl text-gray-800 font-medium mb-4 uppercase">
                @forelse ($productData as $product)
                    @if ($loop->first)
                        <h1 class="text-6xl text-gray-800 font-medium mb-4 uppercase">
                            {{ $this->product->first()->product_category }}</h1>
                    @endif
                @empty
    ...
    <form class="mx-auto container pt-6" wire:submit.prevent="search">
        <div class="flex">
                    ...
                    <div class="flex gap-7">
                        <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                            ...
                            <button wire:click="addToCart({{ $productDetail->id }})"
                                class="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100">Add
                                to Cart</button>
                        </div>
